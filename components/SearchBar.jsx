...
function SearchBar() {
  ...
  return (
    <div className="relative flex flex-col">
      ...
      {isSearching && matchingDrops.length > 0 && windowWidth >= 768 && (
        <div className="absolute top-[38px] z-[999] w-full border-l border-r border-b bg-[#000000BF] h-96 flex flex-col overflow-y-auto divide-y">
          {matchingDrops.map((drop, index) => (
            <SearchBarItem
              index={index}
              key={drop.name}
