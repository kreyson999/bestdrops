...
const DropItem = ({drop, isBig, isRow}) => {
  ...
  return (
    <>
      <a href={`/drops/${slug}`} className={`block dropitem relative border-2 md:border-4 bg-white border-blue-600 ${isRow ? 'grid grid-cols-2 transition duration-500 transform hover:-translate-y-1' : 'aspect-square'} h-full w-full overflow-hidden rounded-2xl z-10 `}>
